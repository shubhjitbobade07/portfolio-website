...
import { staggerContainer, staggerItem, sectionHeader } from '../utils/motionVariants';
  ...
  return (
    <section id="snapshot" className="py-12 px-6 bg-slate-950/40 border-y border-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div variants={staggerItem} className="bg-slate-900/40 border border-slate-800/80 p-4 rounded-xl flex items-start gap-3">
          ...
          <motion.div variants={staggerItem} className="bg-slate-900/40 border border-slate-800/80 p-4 rounded-xl flex items-start gap-3 lg:col-span-2">
